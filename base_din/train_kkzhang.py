...
########### Amazon-Eletronics ###########
with open('/home/kkzhang/kdd2020/kkzhang/ant_ctr/Recommendation_kzhang/raw_data/dataset.pkl', 'rb') as f:

########### Amazon-Books ###########
#with open('/home/kkzhang/Ant_financial/ant_ctr/Recommendation_kzhang/raw_data_book/dataset_book_small.pkl', 'rb') as f:
...
print("len_cate_list: ", len(cate_list))
print("test_set_0_5: ", test_set[:5])
